...
/**
 * Centralized Theme system (initial provider implementation).
 *
 * This file mirrors the previous theme implementation but is placed
 * under src/theme/index.jsx so src/theme.jsx can re-export it for
 * backward-compatible imports (`./theme`).
 */
export const THEMES = {
  graphite: {
    id: "graphite",
